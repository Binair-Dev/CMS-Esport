...
export const PLACEHOLDER_WEBSITE_NAME = "Nom du site"
export const PLACEHOLDER_WEBSITE_DESCRIPTION = "Description"
export const PLACEHOLDER_USERNAME = "Pseudo"
export const PLACEHOLDER_LASTNAME = "Nom de famille"
export const PLACEHOLDER_FIRSTNAME = "Prenom"
export const PLACEHOLDER_EMAIL = "Email"
export const PLACEHOLDER_PASSWORD = "Mot de passe"
export const PLACEHOLDER_PASSWORD_CONFIRM = "Confirmation de votre mot de passe"
export const PLACEHOLDER_WEBSITE_STREET = "Rue";
export const PLACEHOLDER_WEBSITE_NUMBER = "Numero";
